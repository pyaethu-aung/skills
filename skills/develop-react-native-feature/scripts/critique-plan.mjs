 ...
 *
 * Why: the Phase 4 critique (the skill's own rubric pass over simulator and
 * emulator screenshots and the diff) normally hands its findings back to the
 * user, which halts a hands-free (--auto) run. But Phase 4 also writes each
 * critique to
...
const CRITIQUE_DIR = '.cache/develop-react-native-feature/critique';
